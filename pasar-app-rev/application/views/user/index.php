...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="assets/components/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="assets/components/vendor/icofont/icofont.min.css" rel="stylesheet">
  <link href="assets/components/vendor/remixicon/remixicon.css" rel="stylesheet">
  <link href="assets/components/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  <link href="assets/components/vendor/owl.carousel/assets/owl.carousel.min.css" rel="stylesheet">
  <link href="assets/components/vendor/venobox/venobox.css" rel="stylesheet">
  <link href="assets/components/vendor/aos/aos.css" rel="stylesheet">

  <!-- Template Main CSS File -->
  <link href="assets/components/css/style.css" rel="stylesheet">
...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
          <img src="assets/components/icon/homemin.svg" class="img-fluid animated" alt="">
        </div>
      ...
      <div class="container">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="300">
          <div class="col-lg-3 col-md-4 komoditas-img">
            <div class="icon-box">
              <img width="22%" src="<?=base_url()?>assets/components/icon/sembako.svg" alt="">
              <h3><a href="">Sembako</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
            <div class="icon-box">
              <img width="22%" src="<?=base_url()?>assets/components/icon/Buah dan Sayur.svg" alt="">
              <h3><a href="">Sayur dan Buah</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
            <div class="icon-box">
              <img width="22%" src="<?=base_url()?>assets/components/icon/Alat Rumah Tangga.svg" alt="">
              <h3><a href="">Perkakas</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4 mt-lg-0">
            <div class="icon-box">
              <img width="22%" src="<?=base_url()?>assets/components/icon/Pakaian.svg" alt="">
              <h3><a href="">Pakaian</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box">
              <img width="22%" src="<?=base_url()?>assets/components/icon/Makanan.svg" alt="">
              <h3><a href="">Makanan</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box">
              <img width="22%" src="<?=base_url()?>assets/components/icon/Daging Sapi, Ayam dan Ikan.svg" alt="">
              <h3><a href="">Daging</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box">
              <img width="22%" src="<?=base_url()?>assets/components/icon/snack.svg" alt="">
              <h3><a href="">Camilan</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box">
              <img width="22%" src="<?=base_url()?>assets/components/icon/Lainnya.svg" alt="">
  ...
  <!-- Vendor JS Files -->
  <script src="assets/components/vendor/jquery/jquery.min.js"></script>
  <script src="assets/components/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="assets/components/vendor/jquery.easing/jquery.easing.min.js"></script>
  <script src="assets/components/vendor/php-email-form/validate.js"></script>
  <script src="assets/components/vendor/waypoints/jquery.waypoints.min.js"></script>
  <script src="assets/components/vendor/counterup/counterup.min.js"></script>
  <script src="assets/components/vendor/owl.carousel/owl.carousel.min.js"></script>
  <script src="assets/components/vendor/isotope-layout/isotope.pkgd.min.js"></script>
  <script src="assets/components/vendor/venobox/venobox.min.js"></script>
  <script src="assets/components/vendor/aos/aos.js"></script>
